# Generated by Django 4.1.7 on 2023-02-21 09:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female'), ('Others', 'Others')], default='Female', max_length=100)),
                ('phone', models.IntegerField()),
                ('status', models.CharField(max_length=200)),
                ('profile_pic', models.ImageField(null=True, upload_to='user')),
